...
(function(){
		...
		createControl : function(id, controlManager) {
			if (id === 'mygallery_button') {
				...
				var button = controlManager.createButton('mygallery_button', {
					...
					image : WordPressTimelineJsData.pluginUrl+'images/Viavi-WordPress-Timeline-button.png',  // path to the button's image
					onclick : function() {
	...
	jQuery(function(){
		...
		var form = jQuery('<div id="mygallery-form"><table id="mygallery-table" class="form-table">\
			<tr>\
				<td><br />Timeline (Zaman Çizelgesi) Grup_ID<br /><br /><small>Timeline_ID değerine Admin Paneli -> Timeline -> Timeline Listesinden ulaşabilirsiniz.</small></td>\
			</tr>\
			<tr>\
				<td>Timeline ID: <input type="text" id="mygallery-groupid" size="10" name="groupid" value="" /><br />\
		...
		form.find('#mygallery-submit').click(function(){
			...
			var shortcode = '[WordPresswptimeline';
