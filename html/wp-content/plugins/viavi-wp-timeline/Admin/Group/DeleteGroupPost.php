...
if (!empty($_GET)){
    ...
    <?php
        ...
        if ($sql){
            ?>
            <p class="WordPress_ok"><?php echo _e('Timeline deleted successfully.','viavi-wp-timeline'); ?></p>
            <?php
        }else{
            ?>
            <p class="WordPress_hata"><?php echo _e('An error occurred while deleting the timeline.','viavi-wp-timeline'); ?></p>
            <?php
        }                
    }
}
